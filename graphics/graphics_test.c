 ...
 *
 * TO COMPILE USE -I/usr/X11R6/include -L/usr/X11R6/lib -lX11
 */

#include "graphics.h"
#include <math.h>

const float circleRadius=0.025, squareLength=0.05, circleColor=0;
...
int main(int argc, char *argv[]) {
  ...
  while(!CheckForQuit()) {
    ...
    DrawRectangle(xA,yA, L, W, squareLength, squareLength, circleColor);
